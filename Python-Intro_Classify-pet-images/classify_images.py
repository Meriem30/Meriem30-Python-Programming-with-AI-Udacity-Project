...
def classify_images(images_dir, results_dic, model):
    ...
    for file_name in results_dic:
      ...
      model_label = classifer(image_dir,model)
      ...
      # get the true label for file from the results dict
      true_label = results_dic[file_name][0]
      ...
      if true_label in model_label:
        ...
        match =  0
      # extend the entry specifying the match result to the dict
      results_dic[file_name].extend([model_label, match])
